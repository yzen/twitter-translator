...
class HomeHandler(tornado.web.RequestHandler):
    def get(self):
        self.render("html/home.html", tweets=[], locale=self.locale.code, query="")
...
class SearchHandler(tornado.web.RequestHandler):
    ...
    def on_search(self, response):
        ...
        self.render("html/home.html", tweets=data["results"], locale=self.locale.code, query=data["query"])
...
class TranslateHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        translateUrl += urllib.urlencode({"v": "1.0", "q": query["text"][0], "langpair": query["lang"][0] + "|" + self.locale.code[0:2]})
        http = tornado.httpclient.AsyncHTTPClient()
